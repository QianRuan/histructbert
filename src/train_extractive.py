...
model_flags = ['para_only','max_nsent','without_sent_pos','ext_layers','base_LM','add_tok_struct_emb', 'add_sent_struct_emb' ,'tok_pos_emb_type','sent_pos_emb_type', 'tok_se_comb_mode' ,'sent_se_comb_mode',
